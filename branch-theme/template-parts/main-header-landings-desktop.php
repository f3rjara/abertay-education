...
$menu_primary = wp_get_menu_array('menu-branch-landing-primary');
  ...
  <div class="container">
    <div class="row w-100">
      ...
      <div class="col-8 col-lg-2 d-flex justify-content-start align-items-center">
        <a aria-label="Abertay Univeristy" class="target_logo">
      ...
      <div class="col-lg-8 col-xl-7 d-none d-lg-flex justify-content-start align-items-center">
      ...
      <div class="col-2 col-lg-1 d-flex justify-content-end align-items-center d-none">
